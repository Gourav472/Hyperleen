                        ...
                        <div key={index} className={`${openIndex === index ? 'border-transparent' : 'border-gray'} w-full border-[0.5px] overflow-hidden rounded-2xl flex mx-auto max-w-[973px] mt-5 justify-center relative duration-300 ease-linear`} data-aos="zoom-in-up" data-aos-duration="1500">
                            <div className="accordion w-full">
                                ...
                                >
                                    ...
                                    <Icon iconName="AccordionIcon" isOpen={openIndex === index} className={`${openIndex === index ? 'rotate-180 bg-white fill-darkBlue' : 'bg-darkBlue fill-white'} duration-500 ease-linear w-6 h-6  rounded-full grid place-items-center`} />
                                </div>
                                <div className="overflow-hidden relative">
                                    ...
                                    >
                                        <p className='text-gray text-xl font_gilroy_regular  max-w-[821px]'>{item.content}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
