        ...
        <div id='about' className='container'>
            <div className='flex flex-col'>
                <div className='flex flex-col items-center'>
                    ...
                    <p data-aos="zoom-in" className='max-w-[740px] font-normal text-base leading-6 text-center pt-4 '>In the realm of sentiment analysis, human judgment plays a crucial role. While our methods may not be extravagant, they are designed to ensure precise and reliable results.</p>
                </div>
            </div>
