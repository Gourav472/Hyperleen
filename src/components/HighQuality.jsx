      ...
      <div data-aos="zoom-in-up" className='flex lg:flex-row flex-col max-lg:items-center gap-5 z-10 lg:pt-[100px] md:pt-20 sm:pt-16 pt-11 relative'>
        <div className='bg-regularWhite rounded-2xl duration-300 hover:shadow-4xl border-[0.5px] border-darkBlue lg:max-w-[326px] max-w-[550px] w-full lg:h-[380px] p-5'>
          ...
          <div className='flex lg:flex-col sm:flex-row flex-col lg:gap-0 gap-2'>
            <img loading='lazy' className='lg:max-w-[285px] sm:max-w-[250px] w-[90%] sm:w-full pointer-events-none' src={labelingPiz} alt="#" />
            <img loading='lazy' className='lg:pt-7 lg:max-w-[285px] w-[90%] sm:max-w-[250px] sm:w-full  pointer-events-none' src={labelingCar} alt="#" />
          </div>
        </div>
        <div className='lg:max-w-[449px] max-w-[550px] w-full 2xl:h-[415px] xl:h-[410px] lg:h-[360px]  p-5 duration-300 hover:shadow-4xl bg-regularWhite rounded-2xl border-[0.5px] border-darkBlue lg:mt-[52px]'>
          <div className='flex justify-between items-center'>
            ...
            <div className='flex gap-3'>
              <div className='flex items-center gap-1 bg-lightBlue border-[0.5px] rounded-xl border-darkBlue p-[6px_12px] max-w-[86px]'>
                ...
                <img loading='lazy' className='h-[20px] w-[20px]  pointer-events-none' src={blueTick} alt="#" />
              </div>
              <div className='flex items-center gap-1 bg-lightBlue border-[0.5px] rounded-xl border-darkBlue p-[6px_12px] max-w-[86px]'>
                <p className='font-semibold font_gilroy_semibold text-xl leading-7 text-black'>
                  10%
                </p>
                <img loading='lazy' className='h-[20px] w-[20px]  pointer-events-none' src={cross} alt="#" />
              </div>
            </div>
          </div>
          <p className='font-semibold font_gilroy_semibold sm:text-xl text-lg leading-7 text-gray py-2'>
          ...
          <div className='flex justify-between gap-2 xl:gap-[47px] pb-[10px] w-full'>
            <img loading='lazy' className='xl:w-full w-[48%] xl:max-w-[258px] pointer-events-none' src={verificationCar} alt="#" />
            <img loading='lazy' className='xl:w-full w-[48%] xl:max-w-[258px] pointer-events-none' src={verificationMan} alt="#" />
          </div>
          <div className='flex justify-between gap-2 xl:gap-[47px] pb-[10px] w-full'>
            <img loading='lazy' className='xl:w-full w-[48%] xl:max-w-[258px] pointer-events-none' src={verificationTomato} alt="#" />
            <img loading='lazy' className='xl:w-full w-[48%] xl:max-w-[258px] pointer-events-none' src={verificationCar} alt="#" />
          </div>
          <div className='flex justify-between xl:gap-[47px] gap-2 w-full'>
            <img loading='lazy' className='xl:w-full w-[48%] xl:max-w-[258px] pointer-events-none' src={verificationMan} alt="#" />
            <img loading='lazy' className='xl:w-full w-[48%] xl:max-w-[258px] pointer-events-none' src={verificationPiz} alt="#" />
          </div>
        </div>
        <div className='bg-regularWhite rounded-2xl duration-300 hover:shadow-4xl border-[0.5px] border-darkBlue xl:max-w-[326px] max-w-[550px] w-full 2xl:h-[380px] lg:h-[380px]  p-5 lg:mt-[147px]'>
          ...
          <p className='font-normal font-poppins text-gray text-base leading-6 pb-2'>
        ...
        <img loading='lazy' className='absolute top-[4%] left-[28%] lg:flex hidden pointer-events-none' src={blueArrow} alt="#" />
        <img loading='lazy' className='absolute pointer-events-none top-[16%] xl:left-[69%] left-[64%] rotate-[10.5deg] lg:flex hidden ' src={blueArrow} alt="#" />
      </div>
    </div>
  )
}
