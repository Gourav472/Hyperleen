                    ...
                    <div className='flex-col items-center flex py-12 sm:py-14 md:py-16 lg:py-[68px] xl:py-[71px]'>
                        ...
                        <div className='flex items-center flex-wrap justify-center gap-4 sm:gap-5 md:gap-3 lg:gap-6 pt-6'>
                            {BUTTONS_DATA.map((item, index) => (
                                <span key={index} className='font-poppins font-normal text-sm sm:text-base leading-6 text-darkBlue p-[8px_12px] sm:p-[9.5px_12px] md:p-[9.5px_18px] lg:p-[9.5px_23.5px] bg-lightPink shadow-3xl border-[0.5px] border-darkBlue rounded-[122px] hover:shadow-none duration-300 ease-linear'>{item.text}</span>
                            ))}
                        </div>
